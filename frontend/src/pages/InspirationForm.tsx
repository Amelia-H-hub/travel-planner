...
export default function InspirationForm() {
  ...
  const budgetOptions = [
    ...
    {label: "Luxury & High-End ($$$)", value: "High"},
  ]
  ...
  return (
        <FormPageLayout
          backgroundImage={inspirationBg}
          title="Where to Next?"
          subtitle="Tell us a bit about yourself, and our AI will curate the perfect vibe for your next trip."
        >
